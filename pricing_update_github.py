...
completed_brands = {"tanglewood": Tanglewood,"dean": Dean, "morley": Dean,  'ernie ball': ErnieBall,
    ...
    , 'ida maria grassi': National, 'w.e. hill & sons': National, 'dycem': National, 'kirlin': National,
                    ...
                    'vitoos': Valencia, 'v-parts': Valencia, 'waltons': Valencia, 'wsc': Valencia, 'wylde': Valencia, 'feadog': Valencia, 'clarke': Valencia,
    ...
    try:
        ...
        try:
            ...
            if brand.lower() in completed_brands:
                ...
                if "ibanez" in brand.lower() or 'epiphone' in brand.lower() or 'esp' in brand.lower() or 'orange' in brand.lower() or 'korg' in brand.lower() or 'vox' in brand.lower() or 'universal audio' in brand.lower() or 'uaguitar' in brand.lower() or  brand.lower() == 'ua':
                    if obsolete_stock == 'Y':
                        pass
                    else:
                        continue
